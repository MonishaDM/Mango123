...
public class EditMenuPage extends WebDriverUtility_Test{
	...
	public String editMenu(HashMap<String, String> map, WebDriver driver,JavaUtility_Test lib,String restName) {
